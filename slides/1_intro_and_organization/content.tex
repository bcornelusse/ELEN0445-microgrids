...
\begin{frame} {Schematic example}
  ...
  Source image taken from \href{https://www.typhoon-hil.com/}{Typhoon HIL website}
\end{frame}
...
\begin{itemize}
  ...
  \item Minimize the total cost of electricity: local electricity may be cheaper than from the grid, at least periodically
...
\begin{frame}[allowframebreaks]{Energy markets}
  ...
  \begin{itemize}
    ...
    \end{itemize} 
    \item Microgrids are most of the time too small to access the market. They’ll have to go through a “third party”, i.e. a retailer + balance responsible party (BRP)
  \end{itemize}
\end{frame}
...
Voltage control
\begin{itemize}
  \item Regulation of voltage at PCC within a specified range (magnitude and phase)
  \item fast real-time, milli seconds
...
\begin{itemize}
  \item Configuration of protections of devices depending on operating conditions (e.g. islanded or not, a genset is up and running or not, etc.)
\end{itemize}
