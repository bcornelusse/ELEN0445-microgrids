...
In this lecture we review microgrid architectures, that is which components form a microgrid and how to interconnect them.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Equipment in general requires fewer components per unit of power transferred
...
\begin{frame}{Automatic transfer switch principle}
  ...
  \centering
  \href{https://youtu.be/883JgMK9EGg}{\includegraphics[width=0.65\textwidth]{images/video_ATS.png}}
...
\begin{columns}
  \begin{column}{0.55\textwidth}
    ...
    \textbf{Grid-forming converters} (Fig (a)): can be represented as an ideal AC voltage source setting the voltage amplitude and frequency of the local electrical grid.
...
\begin{frame}{The car that does much more }
  \begin{center}
  \href{https://youtu.be/5FAsadUM26I}{\includegraphics[width=0.5\textwidth]{images/video_NISSAN_V2G.png}}
  \end{center}
\end{frame}
...
\begin{itemize}
  ...
  \item DC to AC to power AC loads, or to inject into the public grid
...
\begin{frame}{DC vs AC: pros}
  ...
  \item Frequency control is not necessary in DC systems, unwanted harmonic content may be easier to filter too
  \end{itemize}
  \end{column}
  \begin{column}{0.45\textwidth}
    \begin{itemize}
...
\begin{itemize}
  ...
  \item and contribute to the general system stability. "
\end{itemize}
...
\begin{itemize}
  \item During tests
  \item In case of islanding / reconnection after a network fault ("make-beforebreak")
  \item ...
\end{itemize}
