...
Voltage and current rating are a function of material and construction.\\
...
\begin{columns}
  ...
  \begin{column}{0.45\textwidth}
    ...
    \href{https://youtu.be/rhIRD5YVNbs}{\includegraphics[width=0.95\textwidth]{images/video_Lead_1.jpg}}
  \end{column}
\end{columns}
...
During discharge, both electrode reactions create $\mathrm{PbSO}_4$ (lead sulphate) that coats the electrodes
...
Sulfuric acid concentration decreases (as a consequence of the above phenomenon)
...
\begin{frame}{Lithium-Ion batteries}
...
\begin{enumerate}
  ...
  \item Allow deeper discharges (although cycle-life depends on DoD)
\end{enumerate}
...
\begin{center}
  \href{https://youtu.be/VxMM4g2Sk8U}{\includegraphics[width=0.6\textwidth]{images/e7c418a7-6530-46e7-9e4a-0de0bdcf74a7-18_888_1572_434_391}}\\
  \href{https://youtu.be/PVnQ87Fvsk4}{\includegraphics[width=0.6\textwidth]{images/e7c418a7-6530-46e7-9e4a-0de0bdcf74a7-19_919_1578_411_225}}
\end{center}
\end{frame}
...
\end{frame}\begin{frame}{Comparison of Li-Ion Battery Technologies}
\begin{center}
...
\begin{center}
  \href{https://youtu.be/AagO07cHRG8}{\includegraphics[width=0.6\textwidth]{images/e7c418a7-6530-46e7-9e4a-0de0bdcf74a7-24_1014_1586_222_382}}
\end{center}

\begin{center}
  \href{https://youtu.be/UT8vjThfWB4}{\includegraphics[width=0.6\textwidth]{images/e7c418a7-6530-46e7-9e4a-0de0bdcf74a7-25_1084_1585_285_289}}
\end{center}
\end{frame}
...
\begin{itemize}
  ...
  \item a more detailed model can represent the current-voltage dependence and thus the efficiency as a function of the power charged or discharged:\\
\end{itemize}
\begin{columns}
...
Charging strategies refer to the way current and voltage are controlled over time to charge a battery.

Complex strategies exist to maximize the efficiency and the safety of the process

\begin{itemize}
  \item constant current CC is the simplest, but can lead to overvoltage if not stopped fast enough
...
\end{frame}\begin{frame}{Schematic \& working principle of supercapacitor technology}
\begin{center}
